...
fractal.web.set('builder.dest', `${__dirname}/docs/`); // destination for the static export
fractal.web.set('static.path', __dirname + '/dist/');
fractal.web.theme(theme);

fractal.docs.set('path', `${__dirname}/source/documentation`); // location of the documentation directory.
fractal.docs.set('label', buildConfig.labels.docs);
...
fractal.components.set('label', buildConfig.labels.component);
...
gulp.task('images', function () {
  return gulp.src([buildConfig.paths.images.source])
    .pipe(gulp.dest(buildConfig.paths.images.dist))
    ;
});
